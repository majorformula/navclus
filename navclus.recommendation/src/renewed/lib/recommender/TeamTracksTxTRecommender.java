...
//							System.out.println("Recall:	" + recall);
							...
							totalResults.add(new Result(precision, recall)); // 여기가 수정...
						}
					}
					query.clear();
	...
	public ElementManager retrieve(ElementManager query, TeamTracksMicroClusterManager microClusterManager) {
